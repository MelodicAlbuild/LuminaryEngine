...
namespace LuminaryEngine.ThirdParty.LDtk.Models
{
    ...
    public class LDtkProject
    {
        ...
        [JsonProperty("ldtkVersion")]
        public string LdtkVersion { get; set; }

        [JsonProperty("bgColor")]
        public string BgColor { get; set; }

        [JsonProperty("worldGridSize")]
        ...
        [JsonProperty("levels")]
        public List<LDtkLevel> Levels { get; set; }

        [JsonProperty("defs")]
        public LDtkDefinitions Definitions { get; set; }
    }
    ...
    public class LDtkEnumDef
    {
        ...
        [JsonProperty("values")]
        public List<LDtkEnumValue> Values { get; set; }
    }
    ...
    public class LDtkEntityDef
    {
        ...
        [JsonProperty("fields")]
        public List<LDtkFieldDef> Fields { get; set; }
    }
    ...
    public class LDtkLayerInstance
    {
        ...
        // For auto layers:
        [JsonProperty("autoTiles")]
        public List<LDtkAutoTile> AutoTiles { get; set; }
    ...
    public class LDtkEntityInstance
    {
        ...
        [JsonProperty("tile")]
        public LDtkTileInstance Tile { get; set; }
    ...
    public class LDtkFieldInstance
    {
        ...
        public object DungeonValue { get; set; }
    }
}
